...
export default function Slideshow() {
  ...
  const [frameSize, setFrameSize] = useState({ frameWidth: 270, frameHeight: 180 })
  ...
  useEffect(() => {
    ...
    const handleResize = () => {
      ...
      const newFrameSize = getFrameSize(vw)
      setFrameSize(newFrameSize)
      setNumFrames(Math.ceil((vw * 2) / newFrameSize.frameWidth) + 2)
    }
    handleResize()
  ...
  if (!mounted) {
    return (
      <div className="relative w-full flex justify-center items-center sm:max-w-[60%] md:max-w-[70%] lg:max-w[100%] h-[140px] sm:h-[220px] md:h-[260px] slideshow-viewport overflow-hidden bg-white">
  ...
  return (
    <div className="relative w-full flex justify-center items-center max-w-[80%] md:max-w-[60%] lg:max-w[100%] h-[140px] sm:h-[220px] md:h-[260px] slideshow-viewport overflow-hidden bg-white">
      <div
      ...
      >
        {loopImages.map((src, idx) => (
          ...
          >
            <div
              className="relative w-full flex-1 flex items-center justify-center overflow-hidden rounded-md"
              style={{height: `${frameSize.frameHeight}px`}}
            >
              <Image
                src={src}
